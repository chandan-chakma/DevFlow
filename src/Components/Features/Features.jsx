import { Astroid, BellRing, BuildingComplexPlus, ClipboardCheck, MoveRight, UserGroup, UsersRound } from 'lucide-react';
...
const Features = () => {
    return (
        <div>
            <section id='features' className='text-center bg-base-100 py-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-5 mt-5 px-6'>
            ...
            <section>
                <div className="bg-base-200 py-6">
                    <div className="hero-content flex-col lg:flex-row-reverse items-stretch gap-10">
                        <img
                        ...
                        />
                        <div>
                            <p className='text-primary text-xl'>WORK SMARTER</p>
                            <h1 className="text-5xl font-bold text-neutral my-2">A complete workspace <br></br> for your team</h1>
                            <p className="py-3 text-muted">
                                Bring your projects, tasks,and team together in one place.<br></br> DevFlow helps you pllan, collaborate, and deliver faster<br></br> with a clean and intutive interfcae.
                            </p>
                            <ul className=" flex flex-col gap-2 text-xs">
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                                    <span>Manage multiple workspace</span>
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                                    <span>Keep your team aligned</span>
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                                    <span>Stay organized with powerful tools</span>
                                </li>
            
                            </ul>

                            <button className="btn btn-primary mt-4 w-62">Explore Features
                                <MoveRight size={18} />
                            </button>
                        </div>
                    </div>
